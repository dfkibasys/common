...
public interface MirService {
	...
	MissionInstanceInfo pick(String stationType, String loadType, String stationName, String loadId);

	MissionInstanceInfo drop(String stationType, String loadType, String stationName, String loadId);
