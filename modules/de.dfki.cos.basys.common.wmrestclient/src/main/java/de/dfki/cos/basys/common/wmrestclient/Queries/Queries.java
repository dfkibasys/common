...
public class Queries {
    ...
    public static class HullQueries {
        ...
        public static String GetAllRivetPositions = "prefix ldp: <http://www.w3.org/ns/ldp#> "
                ...
                + ""
                + "SELECT ?rivetUri ?index ?rivetId ?frameId ?status ?frameType ?hullRegion ?frameIndex ?frameUri WHERE {"
                + ""
                + "?hullId dct:identifier '%s'^^<xsd:string>;"
                + "dct:hasPart ["
                + " dct:hasPart ["
                ...
                + "  ]; "
                + " dct:hasPart ["
                + "    dct:identifier 'status'^^<xsd:string>;"
                + "    rdf:value ?status"
                + "  ] "
                + "] ."
                + ""
