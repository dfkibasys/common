...
public class Queries {
    ...
    public static class HullQueries {

        public static String GetAllRivetPositions = "prefix ldp: <http://www.w3.org/ns/ldp#> "
                + "prefix dct: <http://purl.org/dc/terms/> "
                + "prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> "
                + "prefix xsd: <http://www.w3.org/2001/XMLSchema#> "
                + ""
                + "SELECT ?rivetUri ?index ?rivetId ?frameId ?status ?statusUri ?frameType ?hullRegion ?frameIndex ?frameUri WHERE {"
                + ""
                + "?hullUri dct:identifier '%s'^^<xsd:string>;"
                + "dct:hasPart ["
                + " dct:hasPart ["
                + "     dct:identifier 'frames'^^<xsd:string> ;"
                + "     ldp:contains ?frameUri"
                + "  ]"
                + "] ."
                + "?frameUri dct:identifier ?frameId;"
                + "dct:hasPart ["
                + "dct:identifier 'frame'^^<xsd:string>;"
                + "  dct:hasPart ["
                + "    dct:identifier 'rivetPositions'^^<xsd:string>;"
                + "    ldp:contains ?rivetUri"
                + " ];"
                + "  dct:hasPart ["
                + "    dct:identifier 'type'^^<xsd:string>;"
                + "    rdf:value ?frameType;"
                + "  ];"
                + "  dct:hasPart ["
                + "    dct:identifier 'hullregion'^^<xsd:string>;"
                + "    rdf:value ?hullRegion;"
                + "  ];"
                + "  dct:hasPart ["
                + "    dct:identifier 'index'^^<xsd:string>;"
                + "    rdf:value ?frameIndex;"
                + "  ]"
                + "] ."
                + "?rivetUri dct:identifier ?rivetId ;"
                + "dct:hasPart ["
                + " dct:identifier 'rivetposition'^^<xsd:string> ;"
                + " dct:hasPart["
                + "  dct:identifier 'index'^^<xsd:string> ;"
                + "  rdf:value ?index "
                + "  ]; "
                + " dct:hasPart ?statusUri "
                + " ] ."
                + " ?statusUri dct:identifier 'status'^^<xsd:string>;"
                + "    rdf:value ?status ."
                + ""
                + "FILTER isLiteral(?index)"
                + "FILTER isLiteral(?status)"
                + "FILTER isLiteral(?frameIndex)"
                + "FILTER isLiteral(?frameType)"
