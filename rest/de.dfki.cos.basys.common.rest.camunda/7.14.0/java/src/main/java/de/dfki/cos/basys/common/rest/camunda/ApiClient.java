...
import de.dfki.cos.basys.common.rest.camunda.auth.Authentication;
import de.dfki.cos.basys.common.rest.camunda.auth.HttpBasicAuth;
import de.dfki.cos.basys.common.rest.camunda.auth.HttpBearerAuth;
import de.dfki.cos.basys.common.rest.camunda.auth.ApiKeyAuth;

@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2021-03-11T21:54:35.456Z[GMT]")
public class ApiClient extends JavaTimeFormatter {
  protected Map<String, String> defaultHeaderMap = new HashMap<String, String>();
  protected Map<String, String> defaultCookieMap = new HashMap<String, String>();
  protected String basePath = "http://localhost:8080/engine-rest";
  ...
  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      ...
      "The API server for the default process engine",
      new HashMap<String, ServerVariable>() {{
        ...
        put("contextPath", new ServerVariable(
          "No description provided",
          "engine-rest",
          new HashSet<String>(
          )
    ...
    new ServerConfiguration(
      ...
      "The API server for a named process engine",
      new HashMap<String, ServerVariable>() {{
        put("host", new ServerVariable(
          "No description provided",
          "localhost",
        ...
        put("engineName", new ServerVariable(
          "No description provided",
          "default",
          new HashSet<String>(
          )
